...
INNER JOIN ESPACIO
ON VISITA.lector = ESPACIO.lector
WHERE VISITANTE.id = 2 AND hora_inicial BETWEEN TO_DATE('2020-11-02-23:59:59', 'YYYY-MM-DD-HH24:MI:SS')-11 AND TO_DATE('2020-11-02-23:59:59', 'YYYY-MM-DD-HH24:MI:SS');  
